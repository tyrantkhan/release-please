...
class Manifest {
    ...
    constructor(github, targetBranch, repositoryConfig, releasedVersions, manifestOptions) {
        ...
        this.groupName = manifestOptions === null || manifestOptions === void 0 ? void 0 : manifestOptions.groupName;
    ...
    async buildPullRequests() {
        ...
        if (!this.separatePullRequests) {
            ...
            if (this.groupName) {
                ...
                mergeOptions.headBranchName = branch_name_1.BranchName.ofGroupTargetBranch(this.groupName, this.targetBranch).toString();
            }
